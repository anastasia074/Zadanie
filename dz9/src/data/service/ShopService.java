...
public class ShopService {
    ...
    final CatalogDataSource catalogDataSoure;
    final CartDataSource cartDataSource;
    final OrderDataSource orderDataSource;

    public ShopService(CatalogDataSource catalogDataSoure, CartDataSource cartDataSource, OrderDataSource orderDataSource) {
